...
const REGISTER_URL = '/api/inscription';
        ...
        <>
            ...
            {success ? (
                ...
                <section className="Signup_box">
                    ...
                    <h1 className="Signup_title" >S'inscrire</h1>
                    <form className='Signup_form' onSubmit={handleSubmit}>
                        <label className="Signup_label" htmlFor="username">
                            Nom d'utilisateur:
                        ...
                        <label className="Signup_label" htmlFor="confirm_pwd">
